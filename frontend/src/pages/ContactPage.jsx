        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <SlideInLeft className="lg:col-span-2">
            <div className="space-y-8">
              ...
              {[
                { icon: Mail, label: 'Email Us', value: 'rushikesh5953@gmail.com', sub: 'rushikesh5953@gmail.com', href: 'mailto:rushikesh5953@gmail.com' },
                { icon: Phone, label: 'Call Us', value: '+91 98810 75953', sub: '+91 98810 75953 (WhatsApp)', href: 'tel:+919881075953' },
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  {[
                    { icon: Camera, href: 'https://www.instagram.com/rushikesh__rv_12?igsh=Z2VxODBwbGZ6bTY1', color: 'hover:bg-pink-500/20 hover:border-pink-500/40 hover:text-pink-400' },
                    { icon: Users, href: 'https://www.facebook.com/share/1LE7B1Suvy/', color: 'hover:bg-blue-500/20 hover:border-blue-500/40 hover:text-blue-400' },
                    ...
                    { icon: Briefcase, href: 'https://www.linkedin.com/in/rushikesh-r-deshmukh/', color: 'hover:bg-blue-600/20 hover:border-blue-600/40 hover:text-blue-300' },
