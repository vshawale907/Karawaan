...
import {
  LayoutDashboard, Inbox, Settings, ChevronRight, Menu, LogOut, Search, Bell, Sun, Moon, User, BarChart3, ClipboardList
} from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Partner Surveys', icon: ClipboardList, path: '/admin/surveys' },
...
export default function AdminLayout() {
  ...
  // Handle redirect if not logged in or wrong role
  useEffect(() => {
    if (!currentUser) {
      navigate('/login');
      ...
      <div className="flex items-center gap-3 px-5 py-6 border-b border-slate-200/80 dark:border-white/5">
        ...
        {sidebarOpen && (
          <div className="flex flex-col justify-center">
            ...
            <p className="text-[9px] text-slate-400 dark:text-white/40 tracking-[0.25em] uppercase font-sans mt-0.5">
              Admin Portal
            </p>
          </div>
        )}
