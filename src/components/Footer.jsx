            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@karawaan.com" className="text-white/60 hover:text-gold text-sm transition-colors">
                    info@karawaan.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+919876543210" className="text-white/60 hover:text-gold text-sm transition-colors">
                    +91 98765 43210
                  </a>
                </div>
              </li>
